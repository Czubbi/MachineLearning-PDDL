...
class FreeVariableConstraint:
        def __init__(self, action_arguments_rule, free_variables, compliant_values):
                ...
                self.compliant_values = set(compliant_values)
                #assert(len(list(self.compliant_values)[0]) == len(self.free_variables) + len(self.action_arguments))
